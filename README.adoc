...
image::https://user-images.githubusercontent.com/63274055/167261665-f99cff9d-fe81-40ad-b7ac-34f6e2a0020c.png[width=800]
...
Having the data buffered into Kinesis, the data needs to be processed and sent to DynamoDB.
====
''''
====
