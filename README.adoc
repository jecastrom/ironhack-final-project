...
# If the method is POST we send in our data. From the "event" we extract the body JSON, take this p_record string then we dump it into a recordstring variable.
