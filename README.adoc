= High Volume Streaming Data Ingestion Platform on AWS  - Final Project
...
** Look for any anomalies in the data, data types
...
TIP: I have noticed that in the dataset there were some invoice numbers that had a combination of numbers and letters. I have replaced all letters on the invoice numbers by a 9 and tested again with a csv file with 995 transactions to simulate the data streaming and It works!
